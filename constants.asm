...
def IS_DPAD equ(%00001111)

def X_COORD_LEFT_SIDE_OF_SCREEN_WRAP_AROUND_PREVENTION equ(2)
def X_COORD_RIGHT_SIDE_OF_SCREEN_WRAP_AROUND_PREVENTION equ(93)
def Y_COORD_TOP_OF_SCREEN_WRAP_AROUND_PREVENTION equ(2)
def Y_COORD_BOTTOM_OF_SCREEN_WRAP_AROUND_PREVENTION equ(113)

def BACKGROUND_AND_INNER_PALETTE equ(%11100100)
def INNER_DEMON_PALETTE equ(%00011011)

def WINDOW_X_COORD equ(7)
def START_SCREEN_INITIAL_WINDOW_Y_COORD equ(144)
def GAME_LEVEL_WINDOW_Y_COORD equ(120)

def START_SCREEN_POS_X_COORD equ(0)
def START_SCREEN_POS_Y_COORD equ(0)
def GAME_LEVEL_SCREEN_POS_X_COORD equ(0)
def GAME_LEVEL_SCREEN_POS_Y_COORD equ(50)

def NUM_SPRITES_MAKING_UP_ENTITY_SIDE equ(2)
...
def LEVEL_2_NUM_INNER_DEMONS equ(2)
...
def ENTITY_WALKING_ANIMATION_OFFSET equ(2)

def KEEPS_SPRITE_AS_ONE_OF_TWO_VALID_WALKING_RIGHT_SPRITES equ(%01000011)
def KEEPS_SPRITE_AS_ONE_OF_TWO_VALID_WALKING_LEFT_SPRITES equ(%01000010)
def KEEPS_SPRITE_AS_ONE_OF_TWO_VALID_WALKING_UP_SPRITES equ(%00001010)
def KEEPS_SPRITE_AS_ONE_OF_TWO_VALID_WALKING_DOWN_SPRITES equ(%00000010)
def SPRITE_FLIP equ(%00000001)
...
def INNER_DEMON_LEVEL_2_RESPAWN_X   equ(28 * 8)
def INNER_DEMON_LEVEL_2_RESPAWN_Y   equ(22 * 8)
def INNER_DEMON_LEVEL_3_RESPAWN_X   equ(26 * 8)
def INNER_DEMON_LEVEL_3_RESPAWN_Y   equ(8 * 8)
...
def PRINT_BOX_LINE_HEIGHT           equ(8)
...
def GLOBAL_Y_COORD_OFFSET equ(16)
def GLOBAL_X_COORD_OFFSET equ(8)
def TILE_WIDTH equ(8)
def WALL_BYTES_IN_MAP_ROW equ(4)
